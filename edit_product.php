    ...
    <div class="container">
        <div class="mt-5">
            <div class="text-end mb-2">
                <a href="add_product.php" style="width: 100px;" class="btn btn-outline-primary">Back</a>
            </div>
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form_cotainer" action="edit_product.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <label for="product_catagory" class="form-lable required">Catagory <span class="text-danger"><b>*</b></span></label>
                            <div class="col-md-10">
                        ...
                        <input type="file" accept="image/*" name="product_image" id="product_image" class="form-control mb-3 mt-4" value="<?php echo $row['product_image_path'] ?>">

                        <label for="product_name" class="form-lable">Product Name</label>
                        <input type="text" name="product_name" id="product_name" class="form-control mb-3 mt-4" value="<?php echo $row['product_name'] ?>" required>

                        <label for="product_color" class="form-lable">Add Color</label>
                        <input type="text" name="product_color" id="product_color" class="form-control mb-3 mt-4" value="<?php echo $row['product_color'] ?>" required>

                        <label for="product_storage" class="form-lable">Storage</label>
                        <input type="text" name="product_storage" id="product_storage" class="form-control mb-3 mt-4" value="<?php echo $row['product_storage'] ?>" required>
